...
var SolarCalc = function(date, lat, long) {
  this.date = date;
  this.lat = lat;
  this.long = long;
...
SolarCalc.prototype.solarNoon = function() {
  return calcSolNoon(this.julianDate, this.long, this.date);
};

SolarCalc.prototype.sunrise = function() {
  return calcSunriseSet(true, 'sunrise', this.julianDate, this.date, this.lat, this.long);
};

SolarCalc.prototype.sunset = function() {
  return calcSunriseSet(false, 'sunrise', this.julianDate, this.date, this.lat, this.long);
};

SolarCalc.prototype.sunriseEnd = function() {
  return calcSunriseSet(true, 'sunriseEnd', this.julianDate, this.date, this.lat, this.long);
};

SolarCalc.prototype.sunsetStart = function() {
  return calcSunriseSet(false, 'sunriseEnd', this.julianDate, this.date, this.lat, this.long);
};

SolarCalc.prototype.dawn = function() {
  return calcSunriseSet(true, 'twilight', this.julianDate, this.date, this.lat, this.long);
};

SolarCalc.prototype.dusk = function() {
  return calcSunriseSet(false, 'twilight', this.julianDate, this.date, this.lat, this.long);
};

SolarCalc.prototype.nauticalDawn = function() {
  return calcSunriseSet(true, 'nauticalTwilight', this.julianDate, this.date, this.lat, this.long);
};

SolarCalc.prototype.nauticalDusk = function() {
  return calcSunriseSet(false, 'nauticalTwilight', this.julianDate, this.date, this.lat, this.long);
};

SolarCalc.prototype.nightStart = function() {
  return calcSunriseSet(false, 'night', this.julianDate, this.date, this.lat, this.long);
};

SolarCalc.prototype.nightEnd = function() {
  return calcSunriseSet(true, 'night', this.julianDate, this.date, this.lat, this.long);
};

SolarCalc.prototype.goldenHourStart = function() {
  return calcSunriseSet(false, 'goldenHour', this.julianDate, this.date, this.lat, this.long);
};

SolarCalc.prototype.goldenHourEnd = function() {
  return calcSunriseSet(true, 'goldenHour', this.julianDate, this.date, this.lat, this.long);
};
